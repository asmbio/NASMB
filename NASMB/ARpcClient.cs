...
namespace NASMB
{
    ...
    public class ARpcClient : ClientBase
    {
        ...
        //eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBbGxvdyI6WyJyZWFkIiwid3JpdGUiLCJzaWduIiwiYWRtaW4iXX0.ae22SYWjZ_RJRRhfWDpVFzWThu_6EQ-iBgAn8vdrR-w
        static AuthenticationHeaderValue DefaultauthenticationHeaderValue = new AuthenticationHeaderValue("Bearer", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBbGxvdyI6WyJyZWFkIiwid3JpdGUiLCJzaWduIiwiYWRtaW4iXX0.ae22SYWjZ_RJRRhfWDpVFzWThu_6EQ-iBgAn8vdrR-w");
        private string name = "";
        static volatile int _id = 1;
        public ARpcClient(string url, string _name, AuthenticationHeaderValue authHeaderValue = null,
        ...
        protected override async Task<T> SendInnerRequestAsync<T>(string method, string route = null, params object[] paramList)
        {
            var request = new RpcRequestMessage(_id++, $"{name}.{method}", paramList);
